        ...
        m('.col-12.col-md-12.col-lg-6.mt-4.mb-4.mt-lg-0.mb-lg-0', [
          m('.d-flex.align-items-center.ms-3.ms-lg-0.text-lg-end.pt-1', [
            ...
            m('a',
              ...
              m('i.bi.bi-facebook.ms-3.me-3.c-grey', m.trust(FacebookIcon)),
            ),
            m('a',
              { href: 'https://twitter.com/gradido', target: '_blank' },
              m('i.bi.bi-twitter.ms-3.me-3.c-grey', m.trust(TwitterXIcon)),
            ),
            m('a',
              { href: 'https://www.youtube.com/c/GradidoNet', target: '_blank' },
              m('i.bi.bi-youtube.ms-3.me-3.c-grey', m.trust(YouTubeIcon)),
            ),
            m('a', 
              { href: 'https://t.me/Gradido', target: '_blank' }, 
              m('i.bi.bi-telegram.ms-3.me-3.c-grey', m.trust(TelegramIcon)),
            ),
          ]),
        ]),
      ]),
