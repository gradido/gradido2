 ...
 * a small mithril bundle, and hosting it apart from the server it talks to buys nothing — so
 * in production the browser has no cross-origin question to ask and these headers are never
 * read. Everything except loopback is therefore refused there rather than wildcarded:
